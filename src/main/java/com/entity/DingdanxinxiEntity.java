...
public class DingdanxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：租赁月长
	 */
	public void setZulinyuezhang(Integer zulinyuezhang) {
		this.zulinyuezhang = zulinyuezhang;
	}
	/**
	 * 获取：租赁月长
	 */
	public Integer getZulinyuezhang() {
		return zulinyuezhang;
	}
	/**
	 * 设置：金额
	 */

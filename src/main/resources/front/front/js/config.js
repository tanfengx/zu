...
var menu = [{
    "backMenu": [{
        ...
        }, {"buttons": ["查看", "修改", "删除"], "menu": "已发货订单", "tableName": "orders/已发货"}], "menu": "订单管理"
    }],
    "frontMenu": [{
        "child": [{
            "buttons": ["查看", "查看评论", "租赁"],
    ...
    "backMenu": [{
        ...
        "child": [{"buttons": ["查看", "收货"], "menu": "发货订单", "menuJump": "列表", "tableName": "fahuodingdan"}],
        "menu": "发货订单管理"
    }, {
        "child": [{"buttons": ["查看", "归还"], "menu": "租借订单", "menuJump": "列表", "tableName": "zujiedingdan"}],
        "menu": "租借订单管理"
    }, {
        "child": [{"buttons": ["查看"], "menu": "完成订单", "menuJump": "列表", "tableName": "wanchengdingdan"}],
        "menu": "完成订单管理"
    }, {
    ...
    "backMenu": [{
        ...
        "child": [{"buttons": ["查看"], "menu": "发货订单", "menuJump": "列表", "tableName": "fahuodingdan"}],
        "menu": "发货订单管理"
    }, {
        "child": [{"buttons": ["查看"], "menu": "租借订单", "menuJump": "列表", "tableName": "zujiedingdan"}],
        "menu": "租借订单管理"
    }, {
        "child": [{
            "buttons": ["查看", "审核"],
        ...
        "child": [{"buttons": ["查看"], "menu": "信誉值", "menuJump": "列表", "tableName": "xinyuzhi"}],
        "menu": "信誉值管理"
    }, {
        "child": [{"buttons": ["查看"], "menu": "已退款订单", "tableName": "orders/已退款"}, {
            "buttons": ["查看"],
            "menu": "已完成订单",
            "tableName": "orders/已完成"
